...
Page(Object.assign({}, Zan.Toast, {
  ...
  onShow: function (options) {
    ...
    wx.request({
      url: "https://shop.playonwechat.com/api/goods-detail?sign=" + sign + '&operator_id=' + app.data.kid,
      data: {
        gid: gid
      },
      header: {
...
//购买
  ...
  tianjia:function(){
    ...
    wx.request({
      url: "https://shop.playonwechat.com/api/collect-goods?sign=" + sign + '&operator_id=' + app.data.kid,
      data: {
        gid: that.data.gid
      },
      header: {
      ...
      success: function (res) {
        ...
        if (status == 1) {
          ...
          wx.request({
            url: "https://shop.playonwechat.com/api/remove-collection?sign=" + sign + '&operator_id=' + app.data.kid,
            data: {
              gid: that.data.gid
            },
            header: {
  ...
  //加入购物车
   addCars: function (e) {
    ...
    wx.request({
      url: "https://shop.playonwechat.com/api/add-carts?sign=" + sign + '&operator_id=' + app.data.kid,
      method: "POST",
      data: {
        gid: that.data.gid,
        num: that.data.price,
