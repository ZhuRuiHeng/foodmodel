...
onShow: function () { 
  ...
  common.getSign(function (){
    ...
    var sign =wx.getStorageSync("sign");
    wx.request({
      url: 'https://shop.playonwechat.com/api/carousel-goods?sign=' + sign + '&operator_id=' + app.data.kid,
      header: {
        'content-type': 'application/json'
      },
      method: "GET",
    ...
    //获取所有分类
    wx.request({
      url: 'https://shop.playonwechat.com/api/get-category?sign=' + sign + '&operator_id=' + app.data.kid,
      method: "GET",
      success: function (res) {
